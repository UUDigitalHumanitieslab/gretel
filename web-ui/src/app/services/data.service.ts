...
export class DataService {
  ...
  getData(): Observable<Result[]> {
    ...
    return this.http.get("http://localhost:8080/gretel//basex-search-scripts/get-all-results.php?sid=t66bosvmuf97j06vg6ldu2fec5-1521720997", {"withCredentials": true})
      .map((res: any) => {
