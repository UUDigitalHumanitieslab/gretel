...
class TreebankComponent
{
    ...
    /** @var bool Optional: Disable searching for this component - defaults to false */
    public $disabled;
     ...
     * @param int|string  $sentences
     * @param int|string  $words
     * @param string      $group
...
class TreebankMetadata
{
    ...
    public $facet;
    /** @var bool Whether to show this metadata as a filter in the UI */
    public $show;
...
class TreebankInfo
{
    ...
    /** @var bool Optional: Allow searching multiple components simultaneously, defaults to true */
    public $multioption;
    ...
    /** @param bool $v @return this */
    public function setmultioption($v)
    {
        $this->multioption = $v;
