...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>
                <label>
                    <input type="radio" data-treebank="sonar" name="subtreebank[]" value="WRPEE"> WR-P-E-E</label>
            </td>
            <td>Newsletters</td>
            <td>115</td>
        </tr>
        ...
        <tr>
            <td>
                <label>
                    <input type="radio" data-treebank="sonar" name="subtreebank[]" value="WRPEH"> WR-P-E-H</label>
            </td>
            <td>Teletext pages</td>
            <td>40,715</td>
        </tr>
        <tr>
            <td>
                <label>
                    <input type="radio" data-treebank="sonar" name="subtreebank[]" value="WRPEI"> WR-P-E-I</label>
            </td>
            <td>Websites</td>
            <td>204,998</td>
        </tr>
        ...
        <tr>
            <td>
                <label>
                    <input type="radio" data-treebank="sonar" name="subtreebank[]" value="WRPEK"> WR-P-E-K</label>
            </td>
            <td>Blogs</td>
            <td>8,614</td>
        </tr>
        ...
        <tr>
            <td>
                <label>
                    <input type="radio" data-treebank="sonar" name="subtreebank[]" value="WRPPC"> WR-P-P-C</label>
            </td>
            <td>Brochures</td>
            <td>74,897</td>
        </tr>
        <tr>
            <td>
                <label>
                    <input type="radio" data-treebank="sonar" name="subtreebank[]" value="WRPPD"> WR-P-P-D</label>
            </td>
            <td>Newsletters</td>
            <td>2,184</td>
        </tr>
        ...
        <tr>
            <td>
                <label>
                    <input type="radio" data-treebank="sonar" name="subtreebank[]" value="WRPPF"> WR-P-P-F</label>
            </td>
            <td>Legal texts</td>
            <td>650,211</td>
        </tr>
        ...
        <tr>
            <td>
                <label>
                    <input type="radio" data-treebank="sonar" name="subtreebank[]" value="WRPPI"> WR-P-P-I</label>
            </td>
        ...
        <tr>
            <td>
                <label>
                    <input type="radio" data-treebank="sonar" name="subtreebank[]" value="WRPPJ"> WR-P-P-J</label>
            </td>
            <td>Proceedings</td>
            <td>16,935</td>
        </tr>
        <tr>
            <td>
                <label>
                    <input type="radio" data-treebank="sonar" name="subtreebank[]" value="WRPPK"> WR-P-P-K</label>
            </td>
            <td>Reports</td>
            <td>93,507</td>
        </tr>
        ...
        <tr>
            <td>
                <label>
                    <input type="radio" data-treebank="sonar" name="subtreebank[]" value="WRUEE"> WR-U-E-E</label>
            </td>
        ...
        <tr>
            <td>
                <label>
                    <input type="radio" data-treebank="sonar" name="subtreebank[]" value="WSUEA"> WS-U-E-A</label>
            </td>
            <td>Auto cues</td>
            <td>2,163,521</td>
        </tr>
        <tr>
            <td>
                <label>
                    <input type="radio" data-treebank="sonar" name="subtreebank[]" value="WSUTB"> WS-U-T-B</label>
            </td>
            <td>Texts for the visually impaired</td>
            <td>44,862</td>
        </tr>
        <tfoot>
            <tr>
